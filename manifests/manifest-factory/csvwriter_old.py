...
base = [f"https://llkn576nqxepo6yucgfh2nl2ea0kkigc.lambda-url.eu-west-2.on.aws/iiif/2/m{doc}/m{doc}-{i+1}" for i in range(max)]
...
def csvwriter(rows):
  ...
  with open(f"m{doc}-data.csv", "x") as csv_file:
